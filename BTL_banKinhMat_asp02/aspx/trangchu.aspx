<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="trangchu.aspx.cs" Inherits="BTL_banKinhMat_asp02.aspx.trangchu" %>
...
<body>
    ...
    <div class="banner">
        <div class="banner_img">
            <img class="" src="/image-kinhmat/banner01.png" /> 
        </div>
    </div>

    <div class="container_body">
        <div id="bang" name="bang" runat="server" style="grid-column-start: 3; grid-column-end: 12; display: flex; flex-wrap: wrap;"> </div>
        

            <%--<div class="content">
                <div class="sach sanpham">
                    <a href="/web_bankinhmat/trangChiTietSanPham.html"><img src="/image-kinhmat/kinh01.jpeg"></a>
                    <p>800 USD</p>
                </div>
